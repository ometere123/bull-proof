"""Direct-mode tests for BullProof's prospective negative-evidence protocol."""
...
CLASSIFIER = r"You are adjudicating one prospective BullProof negative-evidence observation"
